...
//    membuat array untuk data spinner
    String[] wisata={"Semua", "Bahasa", "Budaya", "Agama", "Musik", "Gaya Hidup"};
    ...
    String[] Subhead = {"Indonesia adalah negara terbaik di dunia..., Baca selengkapnya >>>.", "Arab Saudi adalah negara terbaik di dunia..., Baca selengkapnya >>>", "Belanda adalah negara terbaik di dunia..., Baca selengkapnya >>>", "Argentina adalah negara terbaik di dunia..., Baca selengkapnya >>>","Amerika Serikat adalah negara terbaik di dunia..., Baca selengkapnya >>>", "India adalah negara terbaik di dunia..., Baca selengkapnya >>>", "Irlandia adalah negara terbaik di dunia..., Baca selengkapnya >>>","Irak adalah negara terbaik di dunia..., Baca selengkapnya >>>"
    };
